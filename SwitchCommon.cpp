...
void SwitchCommon::set_imu_data()
{
  ...
  uint8_t imu_data[49] = {
      0x75, 0xFD, 0xFD, 0xFF, 0x09, 0x10,
      0x21, 0x00, 0xD5, 0xFF, 0xE0, 0xFF,
      0x72, 0xFD, 0xF9, 0xFF, 0x0A, 0x10,
      0x22, 0x00, 0xD5, 0xFF, 0xE0, 0xFF,
      0x76, 0xFD, 0xFC, 0xFF, 0x09, 0x10,
...
void SwitchCommon::spi_read()
{
  ...
  else if (addr_top == 0x60 && addr_bottom == 0x20)
  {
    ...
    uint8_t sa_calibration[24] = {0x00, 0x00, 0x00, 0x00, 0x68, 0x10,  // 1
