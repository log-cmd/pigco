...
UCHAR CH9120_Mode = UDP_SERVER; //Optional:TCP_SERVER、TCP_CLIENT、UDP_SERVER、UDP_CLIENT
UCHAR CH9120_LOCAL_IP[4] = {192, 168, 0, 200};    // LOCAL IP
UCHAR CH9120_GATEWAY[4] = {192, 168, 0, 1};       // GATEWAY
UCHAR CH9120_SUBNET_MASK[4] = {255, 255, 255, 0}; // SUBNET MASK
UCHAR CH9120_TARGET_IP[4] = {192, 168, 0, 100};    // TARGET_IP
UWORD CH9120_PORT1 = 12345;                        // LOCAL PORT1
UWORD CH9120_TARGET_PORT = 2000;                  // TARGET PORT
//UDOUBLE CH9120_BAUD_RATE = 115200;                // BAUD RATE
UDOUBLE CH9120_BAUD_RATE = Transport_BAUD_RATE;
